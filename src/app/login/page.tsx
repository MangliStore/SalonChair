  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (error.code === 'auth/unauthorized-domain') {
        errorMessage = `This domain is not authorized. Please go to the Firebase Console for project "${firebaseConfig.projectId}", navigate to Authentication > Settings > Authorized Domains, and add this website's URL.`;
