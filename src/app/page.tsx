    ...
    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
      {filteredSalons.map((salon) => (
        <Card key={salon.id} className="group overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
          <div className="relative h-56 w-full">
            <Image 
              src={salon.imageUrl || "[https://picsum.photos/seed/salon1/600/400](https://picsum.photos/seed/salon1/600/400)"} 
              alt={salon.name} 
              fill 
      ...
      {filteredSalons.length === 0 && !isSalonsLoading && (
         <div className="col-span-full py-20 text-center">
           ...
           <Button variant="link" onClick={() => { setSearch(""); setStateFilter("all"); }}>Reset Search</Button>
         </div>
      )}
    </div>
  </main>
